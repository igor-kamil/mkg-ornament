<template>
    <div class="flex w-full h-screen max-h-screen flex-col border-2 border-black" v-if="items.length !== 0">
        <div class="flex bg-black h-20 md:h-32 2xl:h-48 shrink-0">
            <div class="border-2 border-black w-20 md:w-32 2xl:w-48 shrink-0"></div>
        ...
        <div class="flex bg-black grow">
            <div class="border-2 border-black w-20 md:w-32 2xl:w-48 shrink-0 relative">
            ...
            <div
                class="border-2 border-black grow max-h-[calc(100vh-10rem)] md:max-h-[calc(100vh-16rem)] 2xl:max-h-[calc(100vh-22rem)]"
            >
                <img
                    @click="toggleDetail()"
